...
public class EntityUtils
{
            ...
            float scale, float xAngle, float yAngle, EntityLivingBase ent)
    {
        ...
        try
        {
            ...
            renderManager.doRenderEntity(ent, 0.0D, 0.0D,
                    0.0D, 0.0F, 1.0F, false);
        }
        finally
        {
    ...
    public static void drawEntityOnScreen(int posX, int posY,
            float scale, float mouseX, float mouseY, EntityLivingBase ent)
    {
